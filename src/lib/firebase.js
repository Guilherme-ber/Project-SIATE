...
const firebaseConfig = {
  apiKey: process.env.NEXT_PUBLIC_FIREBASE_API_KEY || "AIzaSyA-mock-key-1234567890abcdefghij",
...
// Inicializa o Firebase apenas se já não houver uma instância ativa
