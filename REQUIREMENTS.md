# Documentação de Requisitos e Regras de Negócio - SIAT

O SIAT (Sistema Integrado de Acompanhamento Técnico) é uma ferramenta desenvolvida para centralizar a gestão administrativa e técnica do projeto de Basquete da UFJF.
